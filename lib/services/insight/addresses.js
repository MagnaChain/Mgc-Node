...
AddressController.prototype.checkAddrs = function(req, res, next) {
  //console.log("################ AddressController.prototype.checkAddrs" );
  var self = this;
  ...
  if (req.params.addr) {
	//console.log("################ AddressController.prototype.checkAddrs req.params: " + JSON.stringify(req.params) );
    req.addr = req.params.addr;
    req.addrs = [req.addr];
  } else if(req.body.addrs) {
	//console.log("################ AddressController.prototype.checkAddrs req.body.addrs: " + JSON.stringify(req.body.addrs) );
    req.addrs = makeArray(req.body.addrs);
  } else {
	//console.log("################ AddressController.prototype.checkAddrs req.params.addr: " + JSON.stringify(req.params.addrs) );
...
AddressController.prototype.utxo = function(req, res) {
  //console.log("#################### AddressController.prototype.utxo");
  var self = this;
...
AddressController.prototype.multiutxo = function(req, res) {
  //console.log("########################### AddressController.prototype.multiutxo");
  var self = this;
  ...
  async.eachLimit(addresses, 4, function(addr, next) {
    //console.log("########################### enter  async.eachLimit(addresses, 4, function(addr, next)");
    self._address.getAddressUnspentOutputs(addr, {}, function(err, utxos) {

      if (err) {
		//console.log("########################### getAddressUnspentOutputs err: " + err );
        return next(err);
      }
      console.log("########################### getAddressUnspentOutputs utxos: " + JSON.stringify(utxos) );
...
AddressController.prototype.multitxs = function(req, res) {
  console.log("########################### AddressController.prototype.multitxs");
  var self = this;
