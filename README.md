...
A MagnaChain blockchain indexing and query service. Intended to be used with as a MagnaChain full node or in conjunction with a Bitcoin full node.

## Upgrading from previous versions of MagnaChain Node

There is no upgrade path from previous versions of MagnaChain Node due to the removal of the included MagnaChain Core software. By installing this version, you must resynchronize the indexes from scratch.
